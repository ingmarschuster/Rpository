 ...
 * found on http://stackoverflow.com/questions/1890854/how-to-replace-special-characters-with-the-ones-theyre-based-on-in-php
 * original on http://www.evaisse.net/2008/php-translit-remove-accent-unaccent-21001
 *
...
function descr_escape( $str )
{
	return iconv('UTF-8', 'ASCII//TRANSLIT', remove_accents($str));
}
?>
